            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-semibold text-2xl text-foreground">8+</span>
                </div>
              ...
              <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-semibold text-2xl text-foreground">500+</span>
                </div>
              ...
              <div className="bg-card rounded-lg p-6 shadow-sm border border-border col-span-2">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-semibold text-lg text-foreground">University of Hohenheim</span>
                </div>
                <p className="text-sm text-muted-foreground">Master's in Plant Protection & Nutrition</p>
              </div>
            </div>
