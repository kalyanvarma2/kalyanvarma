          ...
          <div>
            ...
            <div className="prose prose-lg max-w-none space-y-6">
              {Array.isArray(t.about.content) ? (
                t.about.content.map((paragraph, index) => (
                  <p
                    key={index}
                    className="text-muted-foreground leading-relaxed text-lg text-left"
                  >
                    {paragraph}
                  </p>
                ))
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                >
                  <a
                    href="https://www.linkedin.com/in/kalyan-varma-447721135"
                    target="_blank"
                ...
                >
                  <a
                    href="https://github.com/kalyan-varma"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                >
                  <a
                    href="https://www.instagram.com/imkv_clickz_?igsh=ZXFlZ3M0YnRpNzhw"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
